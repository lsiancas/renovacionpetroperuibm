...
<?php  
 ...
 $sql = "select sum(total) as total, date_format(fecha_emision, '%b') as fecha, date_format(fecha_emision, '%m') as mes from compras where idproveedor = '$proveedor' group by fecha order by mes asc";
 ...
 $Test->setFontProperties("../sic/pChart/Fonts/tahoma.ttf",10);  
 $Test->drawTitle(50,22,"Informacion Compras por Proveedor",50,50,50,585);  
 $Test->Render("pChart/grafico_ver_proveedor.png");  
?>  