...
<?php
 ...
 $sql = "select count(v.idventa), e.estado from ventas v join estados e on v.idestado = e.idestado group by v.idestado";
 ...
 $Test->setFontProperties("../sic/pChart/Fonts/tahoma.ttf",8);
 ...
 $Test->Render("pChart/grafico_ventas.png");
