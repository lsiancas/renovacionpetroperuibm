...
<?php
 ...
 $sql = "select count(v.idventa), tc.tipocomprobante from ventas v join tipocomprobantes tc on v.idtipocomprobante = tc.idtipocomprobante  
group by tc.idtipocomprobante";
 ...
 $Test->Render("pChart/grafico_ventas_comprobantes.png");
