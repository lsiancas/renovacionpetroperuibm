...
<?php
 ...
 $sql = "select count(v.idventa), e.estado from ventas v join clientes cl on v.idcliente=cl.idcliente join monedas m on v.idmoneda=m.idmoneda join estados e on v.idestado=e.idestado

join tipocomprobantes tc on v.idtipocomprobante=tc.idtipocomprobante where v.idmoneda='$moneda' and v.fechaventa like '%-$mes-%' group by e.estado order by v.fechaventa desc, v.numcomprobante desc";
 ...
 $Test->Render("pChart/grafico_ventas_mes_moneda_estados.png");
