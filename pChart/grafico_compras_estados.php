...
<?php
 ...
 $sql = "select count(c.idcompra), e.estado from compras c join estados e on c.idestado = e.idestado group by c.idestado";
 ...
 $Test->Render("pChart/grafico_compras_estados.png");
